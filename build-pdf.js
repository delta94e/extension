...
const SRC_DIR = path.join(__dirname, 'cccd-pdf-extension');
const DIST_DIR = path.join(__dirname, 'dist-pdf');
...
function copyRecursiveSync(src, dest) {
    ...
    if (isDirectory) {
        ...
        if (src.endsWith('.js') && !src.includes('jszip.min.js') && !src.includes('release.js') && !src.includes('pdfjs')) {
